...
CREATE UNIQUE INDEX "uq_local_auth_email" ON "local_auth_credentials" USING btree ("email");--> statement-breakpoint
...
CREATE INDEX "idx_promo_usage_user_created" ON "promo_code_usages" USING btree ("user_id","created_at");--> statement-breakpoint
